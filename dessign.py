...
def sachin():
 ...
 vnpb = 2.5*kb*d*t*fub
 print "------------------------"
 print "\033[1;32m value of vnpb is : ",vnpb
 print "------------------------"
 vdpb = vnpb/gama_mb
 print "--------------------------"
 print "\033[1;32m value of vdpb is : ", vdpb
 print "--------------------------"
 print ""
 ...
 if select == "y":
	 ...
	 sp = sp1/1000
	 print ""
	 print "strength of solid plate is :", sp1
	 print ""
	 eff = vdsb/sp
